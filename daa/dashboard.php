...
<body class="overflow-hidden">
  <div class="lg:flex w-full lg:h-screen lg:py-0 pb-10 overflow-hidden">
    ...
    <div style="position: absolute; right: -50px; top: 20px; z-index: 50;">>
      ...
      <div class="actions flex flex-col flex-grow">
        <ul class="flex flex-col flex-grow">
          <li class="text-blue-600 text-lg text-center cursor-pointer hover:text-blue-500 bg-gray-300 hover:bg-gray-300 mx-3 py-2 mt-3" id="users">
            ...
            <img src="./assets/icons/users.png" alt="users" class="rounded-full w-6 h-6">
          ...
          <div class="flex flex-row justify-center align-center gap-4">
          <img src="./assets/icons/acts.png" alt="activities" class="rounded-full w-6 h-6">
          <div class="collapsible">   Activities</div>
          </li>
          ...
          <div class="flex flex-row justify-center align-center gap-4">
          <img src="./assets/icons/role.png" alt="roles" class="rounded-full w-6 h-6">
          <div class="collapsible">   Roles</div>
          </li>
          ...
          <div class="flex flex-row justify-center align-center gap-4">
          <img src="./assets/icons/tasks.png" alt="tasks" class="rounded-full w-6 h-6">
          <div class="collapsible">   Tasks</div>
          </li>
